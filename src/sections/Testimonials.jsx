...
useEffect(() => {
  ...
  return (
    <div id='testimonials' className='w-full lg:px-[200px] px-8 py-[60px] h-full flex flex-col justify-between items-center gap-5'>
      <h1 data-aos="zoom-in" className='text-4xl uppercase text-white font-poppin font-semibold'>Testimonials</h1>
      <div data-aos="zoom-in" className='bg-themered h-[3px] w-20'></div>
        <p data-aos="zoom-in" data-aos-delay="400" className='text-gray-300 text-lg font-poppins text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium tempore architecto voluptatibus consectetur reiciendis non, placeat</p>

        <div className='w-full grid lg:grid-cols-3 grid-cols-1 justify-between items-start gap-6 mt-10'>
          {reviews.map((item, index) => (
            <div data-aos="zoom-in" data-aos-delay="600" key={index} className='bg-[#2f2f2f] flex flex-col justify-center items-center gap-6 px-5 py-8 rounded-lg'>
              ...
              <img src={item.img} alt="" className='transition-all duration-300 ease-in-out hover:scale-110' />
